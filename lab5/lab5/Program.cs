...
namespace lab5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IReader reader2 = new ReaderSimple("обычный", 1, "Семенов", "Игорь", "Евгеньевич", "муж.", 79835);
            Book Book1 = new Book(1, "Пушкин", "Руслан и Людмила", "Поэма");
            Exemplar exemplar1 = new Exemplar(1, Book, DateTime.Now, "Exmo");
            Position position1 = new Position(1, "Библиотекарь");
            Delivery delivery1 = new Delivery(1, DateTime.Now, employee, reader2, exemplar1);
